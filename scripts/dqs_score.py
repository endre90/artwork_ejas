...
#                 external_penalty += 1
#                 continue
#             elif job in ["T", "L"]:  # Training or Loaned out
#                 continue
...
#         daily_score = (omega * pref_reward) - (alpha * leader_penalty) - (beta * external_penalty) - (gamma * historical_penalty)
...
#     history_file = "/home/endre/rust_ws/artwork_ejas/data/factory/VCE_history.json"
