...
def plot_assignment_history(text_mat, int_mat, days, operators):
    ...
    # Add the title text
    ax.set_title("Calculated rolling assignments for start dates: 16.1, 2.2, 11.2, and 27.2", fontsize=16, pad=40)
    
    # Adjusted rect to tighten the gap between the axes and the text
    plt.tight_layout(rect=[0, 0.06, 1, 1])
    plt.savefig("rolling_total.pdf", bbox_inches="tight")
    plt.show()

def main():
    file_path = "/home/endre/rust_ws/artwork_ejas/data/factory/evaluation/VCE/VCE_rolling_total.json" 
